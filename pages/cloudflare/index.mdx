...
Here’s the updated documentation with the markdown link:

`@opennextjs/cloudflare` is pre-1.0 and still in active development. We intend to support all minor and patch versions from `Next.js 13 to 15`.
